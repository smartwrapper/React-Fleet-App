                        ...
                        <div class="slider-wrapper">
                            <div class="slider-for">
                                ...
                                {{-- <a class="slider-for__item ex1 fancybox-button"
                                    href="./images/gallery/preview/banner_2.png"
                                    data-fancybox-group="fancybox-button" title="Lorem ipsum dolor sit amet">
                                    <img src="./images/gallery/preview/banner_2.png" alt="Zoom Image" />
                                </a>

                                <a class="slider-for__item ex1 fancybox-button"
                                    href="./images/gallery/preview/banner_3.png"
                                    data-fancybox-group="fancybox-button" title="Lorem ipsum dolor sit amet">
                                    <img src="./images/gallery/preview/banner_3.png" alt="Zoom Image" />
                                </a>

                                <a class="slider-for__item ex1 fancybox-button"
                                    href="./images/gallery/preview/banner_4.png"
                                    data-fancybox-group="fancybox-button" title="Lorem ipsum dolor sit amet">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                ...
                                <div class="pro-sub-buttons">
                                    <div class="buttons">
                                        <button type="button" class="btn  btn-link wishlist-icon" style="padding-left: 0;"><i class="fas fa-heart"></i>Add to
                                            Wishlist</button>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="nav nav-pills" role="tablist">
                                    <a class="nav-link nav-item  active" href="#description"
                                    ...
                                    {{-- <a class="nav-link nav-item " href="#additionalInfo"
                                        ...
                                        information</a> --}}
                                    <a class="nav-link nav-item" href="#review" id="review-tab"
                                        data-toggle="pill" role="tab">Reviews</a>
                                </div>
                                                        ...
                                                        <div class="pro-rating">
                                                            ...
                                                            <fieldset class="ratings">
                                                                ...
                                                                <input type="radio" id="star5" name="rating"
                                                                    value="5" class="rating">
                                                                <label class="full fa" for="star5"
                                                                    title="Awesome - 5 stars"></label>


                                                                <input type="radio" id="star4" name="rating"
                                                                    value="4" class="rating">
                                                                <label class="full fa" for="star4"
                                                                    title="Pretty good - 4 stars"></label>

                                                                <input type="radio" id="star3" name="rating"
                                                                    value="3" class="rating">
                                                                <label class="full fa" for="star3"
                                                                    title="Pretty good - 3 stars"></label>

                                                                <input type="radio" id="star2" name="rating"
                                                                    value="2" class="rating">
                                                                <label class="full fa" for="star2"
                                                                    title="Meh - 2 stars"></label>

                                                                <input type="radio" id="star1" name="rating"
                                                                    value="1" class="rating">
                                                                <label class="full fa" for="star1"
                                                                    title="Meh - 1 stars"></label>
                                                    ...
                                                    <div class="review-bubble-bg">
                                                        <div class="pro-rating">
                                                            ...
                                                            <fieldset class="ratings">
                                                                ...
                                                                <input type="radio" id="star05" name="rating0"
                                                                    value="5" class="rating">
                                                                <label class="full" for="star05"
                                                                    title="Awesome0 - 5 stars"></label>


                                                                <input type="radio" id="star04" name="rating0"
                                                                    value="4" class="rating">
                                                                <label class="full" for="star04"
                                                                    title="Pretty0 good - 4 stars"></label>

                                                                <input type="radio" id="star03" name="rating0"
                                                                    value="3" class="rating">
                                                                <label class="full" for="star03"
                                                                    title="Pretty0 good - 3 stars"></label>

                                                                <input type="radio" id="star02" name="rating0"
                                                                    value="2" class="rating">
                                                                <label class="full" for="star02"
                                                                    title="Meh0 - 2 stars"></label>

                                                                <input type="radio" id="star01" name="rating0"
                                                                    value="1" class="rating">
                                                                <label class="full" for="star01"
                                                                    title="Meh0 - 1 stars"></label>
                                                ...
                                                <div class="write-review-box">
                                                    <div class="from-group row mb-3">
                                                        <div class="col-12"> <label
                                                                for="inlineFormInputGroup0">Name</label></div>
                                                    ...
                                                    <div class="from-group row mb-3">
                                                        <div class="col-12"> <label
                                                                for="inlineFormInputGroup1">Email
                                                                Address</label></div>
                                                        <div class="input-group col-12">
                                                    ...
                                                    <div class="from-group row mb-3">
                                                        <div class="col-12"> <label
                                                                for="inlineFormInputGroup2">Review Title</label>
                                                        </div>
                                                        <div class="input-group col-12">
                                                    ...
                                                    <div class="from-group row mb-3">
                                                        <div class="col-12"> <label
                                                                for="inlineFormInputGroup3">Review Body</label>
                                                        </div>
                                                        <div class="input-group col-12">
                                                    ...
                                                    <div class="from-group">
                                                        <button type="button"
                                                            class="btn btn-secondary swipe-to-top">Submit</button>
