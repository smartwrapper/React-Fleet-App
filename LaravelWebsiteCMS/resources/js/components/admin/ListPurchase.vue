                                                ...
                                                <table id="purchase" class="display dataTable no-footer" purchase="grid">
                                                    ...
                                                    <tbody class="kt-table-tbody text-dark">
                                                        <tr class="kt-table-row kt-table-row-level-0 odd" purchase="row" v-for="purchase in purchases" v-bind:key="purchase.id">
                                                            ...
                                                            <td>
                                                                {{ purchase.purchaser != null ? purchase.purchaser.purchaser_first_name+' '+purchase.purchaser.purchaser_first_name :"" }}
                                                            </td>
                                                            <td>
...
export default {
    ...
    methods: {
        ...
        fetchPurchases(page_url) {
            ...
            page_url +='&getPurchaser=1&getPurchaseDetail=1&getProductDetail=1&getProductCombinationDetail=1&getWarehouse=1';
