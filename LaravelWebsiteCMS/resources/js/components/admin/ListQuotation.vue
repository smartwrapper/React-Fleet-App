                                                ...
                                                <table id="purchase" class="display dataTable no-footer" purchase="grid">
                                                    ...
                                                    <tbody class="kt-table-tbody text-dark">
                                                        <tr class="kt-table-row kt-table-row-level-0 odd" purchase="row" v-for="quotation in quotations" v-bind:key="quotation.id">
                                                            ...
                                                            <td>
                                                                {{ quotation.type == 'sale' ? quotation.customer.customer_first_name+' '+quotation.customer.customer_last_name : quotation.purchaser.purchaser_first_name+' '+quotation.purchaser.purchaser_last_name }}
                                                            </td>
                                                            <td>
...
export default {
    ...
    methods: {
        ...
        fetchQuotations(page_url) {
            ...
            page_url +='&getPurchaser=1&getCustomer=1&getWarehouse=1';
